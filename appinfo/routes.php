...
return [
	'routes' => [
		...
		['name' => 'Api#statusUpdate', 'url' => '/api/v1/statuses/{id}', 'verb' => 'PUT'],
		['name' => 'Api#statusGet', 'url' => '/api/v1/statuses/{id}', 'verb' => 'GET'],
		['name' => 'Api#statusContext', 'url' => '/api/v1/statuses/{id}/context', 'verb' => 'GET'],
		['name' => 'Api#statusAction', 'url' => '/api/v1/statuses/{id}/{act}', 'verb' => 'POST'],
